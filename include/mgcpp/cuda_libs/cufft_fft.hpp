...
namespace mgcpp
{
    namespace cufft
    {
        ...
        rfft(size_t n, float const* x, cuComplex* result);
         ...
         */
        inline outcome::result<void>
        rfft(size_t n, double const* x, cuDoubleComplex* result);
         ...
         */
        inline outcome::result<void>
        irfft(size_t n, cuComplex const* x, float* result);
         ...
         */
        inline outcome::result<void>
        irfft(size_t n, cuDoubleComplex const* x, double* result);
         ...
         *  \param direction cufft::fft_direction::forward for forward FFT, or cufft::fft_direction::inverse to perform an inverse (unnormalized) FFT.
         */
        inline outcome::result<void>
        cfft(size_t n, cuComplex const* x, cuComplex* result, fft_direction direction);
         ...
         */
        inline outcome::result<void>
        cfft(size_t n, cuDoubleComplex const* x, cuDoubleComplex* result, fft_direction direction);
         ...
         *  \param result the fft result, which is an array of floor(n/2)+1 complex numbers.
         */
        inline outcome::result<void>
        rfft2(size_t n, size_t m, float const* x, cuComplex* result);
         ...
         *  \param m slowest-changing dimension
         *  \param x input array of (n x m) real values
         *  \param result the fft result, which is an array of (floor(n/2)+1) x m complex numbers.
         */
        inline outcome::result<void>
        rfft2(size_t n, size_t m, double const* x, cuDoubleComplex* result);

        /**
         *  Performs two-dimensional single-precision complex-to-real inverse unnormalized FFT.
         *  Effectively calls the corresponding CuFFT function.
         *  \param n fastest-changing dimension
         *  \param m slowest-changing dimension
         *  \param x input array of (floor(n/2)+1) x m interleaved complex values
         *  \param result the fft result, which is an array of n x m real numbers.
         */
        inline outcome::result<void>
        irfft2(size_t n, size_t m, cuComplex const* x, float* result);

        /**
         *  Performs two-dimensional double-precision complex-to-real inverse unnormalized FFT.
         *  Effectively calls the corresponding CuFFT function.
         *  \param n fastest-changing dimension
         *  \param m slowest-changing dimension
         *  \param x input array of (floor(n/2)+1) x m interleaved complex values
         ...
         */
        inline outcome::result<void>
        irfft2(size_t n, size_t m, cuDoubleComplex const* x, double* result);
         ...
         */
        inline outcome::result<void>
        cfft2(size_t n, size_t m, cuComplex const* x, cuComplex* result, fft_direction direction);
         ...
         */
        inline outcome::result<void>
        cfft2(size_t n, size_t m, cuDoubleComplex const* x, cuDoubleComplex* result, fft_direction direction);
    }
}
