...
namespace mgcpp {
inline outcome::result<void> cufft::rfft(size_t n,
                                         float const* x,
                                         cuComplex* result) {
...
inline outcome::result<void> cufft::irfft(size_t n,
                                          cuComplex const* x,
                                          float* result) {
  std::error_code status;
  cufftHandle plan;
...
inline outcome::result<void> cufft::cfft(size_t n,
                                         cuComplex const* x,
                                         cuComplex* result,
...
inline outcome::result<void> cufft::rfft2(size_t n,
                                          size_t m,
                                          float const* x,
                                          cuComplex* result) {
  std::error_code status;
...
inline outcome::result<void> cufft::irfft2(size_t n,
                                           size_t m,
                                           cuComplex const* x,
                                           float* result) {
  std::error_code status;
...
inline outcome::result<void> cufft::cfft2(size_t n,
                                          size_t m,
                                          cuComplex const* x,
                                          cuComplex* result,
                                          cufft::fft_direction direction) {
