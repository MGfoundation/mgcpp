...
// lv1
template <typename T>
outcome::result<void> dot(cublasHandle_t handle,
                          size_t n,
                          T const* x,
                          size_t incx,
                          T const* y,
...
template <typename T>
outcome::result<void> axpy(cublasHandle_t handle,
                           size_t n,
                           T const* alpha,
                           T const* x,
                           size_t incx,
...
outcome::result<void> scal(cublasHandle_t handle,
                           size_t n,
...
template <typename T>
outcome::result<void> gemv(cublasHandle_t handle,
...
template <typename T>
outcome::result<void> gemm(cublasHandle_t handle,
...
template <typename T>
outcome::result<void> gemm_batched(cublasHandle_t handle,
                                   cublasOperation_t transa,
                                   cublasOperation_t transb,
                                   size_t m,
                                   size_t n,
...
template <typename T>
outcome::result<void> geam(cublasHandle_t handle,
                           cublasOperation_t transa,
                           cublasOperation_t transb,
                           size_t m,
                           size_t n,
