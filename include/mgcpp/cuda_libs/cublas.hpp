...
namespace cublas
{
    ...
    template <typename T>
    inline outcome::result<void> axpy(
    ...
    inline outcome::result<void> scal(
        cublasHandle_t    handle,
        size_t            n,
    ...
    template <typename T>
    inline outcome::result<void> gemv(
        cublasHandle_t    handle,
    ...
    template <typename T>
    inline outcome::result<void> gemm(
        cublasHandle_t    handle,
    ...
    template <typename T>
    inline outcome::result<void> geam(
        cublasHandle_t    handle,
        cublasOperation_t transa,
        cublasOperation_t transb,
        size_t            m,
