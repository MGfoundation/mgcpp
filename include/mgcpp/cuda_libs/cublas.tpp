...
// lv1
template <>
inline outcome::result<void> cublas::dot(
...
template <>
inline outcome::result<void> cublas::axpy(
    cublasHandle_t handle,
    size_t         n,
    float const*   alpha,
    float const*   x,
...
template <>
inline outcome::result<void> cublas::scal(
    cublasHandle_t handle,
    size_t         n,
    float const*   alpha,
    float*         vec,
...
template <>
inline outcome::result<void> cublas::gemv(
    cublasHandle_t    handle,
    ...
    int               incy)
{
    std::error_code status = cublasSgemv(
...
inline outcome::result<void> cublas::gemv(
    ...
    int               incy)
{
    std::error_code status = cublasDgemv(
        handle, trans, m, n, alpha, A, lda, x, incx, beta, y, incy);
...
inline outcome::result<void> cublas::gemv(
    ...
    int               incy)
{
    std::error_code status = cublasCgemv(
        handle, trans, m, n, alpha, A, lda, x, incx, beta, y, incy);
...
inline outcome::result<void> cublas::gemv(
    ...
    int                    incy)
{
    std::error_code status = cublasZgemv(
        handle, trans, m, n, alpha, A, lda, x, incx, beta, y, incy);
...
// lv3
template <>
inline outcome::result<void> cublas::gemm(
    cublasHandle_t    handle,
    ...
    size_t            ldc) noexcept
{
    std::error_code status = cublasSgemm(
...
inline outcome::result<void> cublas::gemm(
    ...
    size_t            ldc) noexcept
{
    std::error_code status = cublasDgemm(
        handle, transa, transb, m, n, k, alpha, A, lda, B, ldb, beta, C, ldc);
...
template <>
inline outcome::result<void> cublas::geam(
    cublasHandle_t    handle,
    cublasOperation_t transa,
    cublasOperation_t transb,
    size_t            m,
    ...
    size_t            ldc) noexcept
{
    std::error_code err = cublasSgeam(
...
inline outcome::result<void> cublas::geam(
    ...
    size_t            ldc) noexcept
{
    std::error_code err = cublasDgeam(
        handle, transa, transb, m, n, alpha, A, lda, beta, B, ldb, C, ldc);
