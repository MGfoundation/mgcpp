...
namespace mgcpp
{
    ...
    scalar_dmat_mult_expr<ScalExpr, DMatExpr>::
    scalar_dmat_mult_expr(ScalExpr const& scal_expr,
                          DMatExpr const& dmat_expr) noexcept
        : _scal_expr(scal_expr),
          _dmat_expr(dmat_expr) {}
    ...
    eval() const
    {
        auto scal = mgcpp::eval(_scal_expr);
        auto dmat = mgcpp::eval(_dmat_expr);
    ...
    template<typename ScalExpr, typename DMatExpr>
    typename scalar_dmat_mult_expr<ScalExpr, DMatExpr>::result_type
    eval(scalar_dmat_mult_expr<ScalExpr, DMatExpr>&& expr)
    { expr.eval(); }

    template<typename Scalar, typename DMatExpr, typename>
    scalar_dmat_mult_expr<Scalar, DMatExpr> 
    ...
    operator*(dmat_expr<DMatExpr> const& mat_expr,
    ...
    operator*(scalar_expr<ScalExpr> const& scalar,
              dmat_expr<DMatExpr> const& mat_expr) noexcept
    {
    ...
    template<typename Scalar, typename DMatExpr, typename>
    scalar_dmat_mult_expr<Scalar, DMatExpr> 
    mult(Scalar scalar, dmat_expr<DMatExpr> const& mat_expr) noexcept
    {
        return scalar_dmat_mult_expr<Scalar, DMatExpr>(scalar, ~mat_expr);
    }
    ...
    template<typename Scalar, typename DMatExpr, typename>
    inline scalar_dmat_mult_expr<Scalar, DMatExpr> 
    mult(dmat_expr<DMatExpr> const& mat_expr,
         Scalar scalar) noexcept
    {
        return scalar_dmat_mult_expr<Scalar, DMatExpr>(scalar, ~mat_expr);
    }
    ...
    template<typename ScalExpr, typename DMatExpr>
    inline scalar_dmat_mult_expr<ScalExpr, DMatExpr> 
    mult(scalar_expr<ScalExpr> const& scalar,
         dmat_expr<DMatExpr> const& mat_expr) noexcept
    {
        return scalar_dmat_mult_expr<ScalExpr, DMatExpr>(~scalar, ~mat_expr);
    }
