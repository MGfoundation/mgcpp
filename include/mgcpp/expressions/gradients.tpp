...
inline auto grad_impl(
    placeholder_node<PlaceholderID, PhResultExprType, PhResultType>,
...
template <size_t PlaceholderID1,
          template <typename> class PhResultExprType1,
          typename PhResultType1,
          typename GradsExpr,
          size_t PlaceholderID2,
          template <typename> class PhResultExprType2,
          typename PhResultType2>
inline auto grad_impl(
    placeholder_node<PlaceholderID1, PhResultExprType1, PhResultType1>,
    expression<GradsExpr> const& grads,
    placeholder_node<PlaceholderID2, PhResultExprType2, PhResultType2>) {
