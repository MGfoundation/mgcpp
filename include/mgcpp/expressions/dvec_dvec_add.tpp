...
namespace mgcpp
{
    ...
    dvec_dvec_add_expr<LhsExpr, RhsExpr>::
    dvec_dvec_add_expr(LhsExpr const& lhs, RhsExpr const& rhs) noexcept
        : _lhs(lhs),
          _rhs(rhs) {}
    ...
    eval(dvec_dvec_add_expr<LhsExpr, RhsExpr> const& expr)
    { expr.eval(); }

    template<typename LhsExpr, typename RhsExpr>
    dvec_dvec_add_expr<LhsExpr, RhsExpr>
    operator+(dvec_expr<LhsExpr> const& lhs,
    ...
    template<typename LhsExpr, typename RhsExpr>
    dvec_dvec_add_expr<LhsExpr, RhsExpr>
    add(dvec_expr<LhsExpr> const& lhs,
        dvec_expr<RhsExpr> const& rhs) noexcept
    {
        return dvec_dvec_add_expr<LhsExpr, RhsExpr>(~lhs, ~rhs);
    }
