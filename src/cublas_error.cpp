...
const char* cublas_error_category_t::name() const noexcept {
  return "cublas";
}

std::string cublas_error_category_t::message(int ev) const {
  switch (static_cast<cublas_error_t>(ev)) {
    ...
    case CUBLAS_STATUS_NOT_INITIALIZED:
      return "CUABLS_STATUS_NOT_INITIALIZED: The cuBLAS library was not "
             "initialized.";
      break;
    ...
    case CUBLAS_STATUS_ARCH_MISMATCH:
      return "CUBLAS_STATUS_ARCH_MISMATCH: The function requires a feature "
             "absent from the device architecture";
      break;
    ...
    case CUBLAS_STATUS_NOT_SUPPORTED:
      return "CUBLAS_STATUS_NOT_SUPPORTED: The operation is not supported by "
             "cublas.";
      break;
#endif
